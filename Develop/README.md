...
back tics - this is the expression
slashes - start to end of expression
parenthesis - within here, these are acceptable characters to have (a-z, 0-9, underscores, period (backslashes means no we mean this particular character bc sometimes period can mean something elses), and dashes)
plus - everything is okay and plus and at sign and then another thing
